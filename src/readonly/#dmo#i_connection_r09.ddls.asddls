@AbapCatalog.sqlViewName: '/DMO/ICONNE_R09'
...
define view /DMO/I_Connection_R09
  as select from /dmo/connecti_09 as Connection

  association [1..*] to /DMO/I_Flight_R09 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier09  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport09',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
