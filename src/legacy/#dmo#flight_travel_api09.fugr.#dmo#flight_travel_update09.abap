...
"! @parameter es_travel              | Evaluated Travel Data like /DMO/TRAVEL09
"! @parameter et_booking             | Table of evaluated Bookings like /DMO/BOOKING09
"! @parameter et_booking_supplement  | Table of evaluated Booking Supplements like /DMO/BOOK_SUP_09
"! @parameter et_messages            | Table of occurred messages
"!
FUNCTION /DMO/FLIGHT_TRAVEL_UPDATE09.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
*"     REFERENCE(IS_TRAVEL) TYPE  /DMO/IF_FLIGHT_LEGACY09=>TS_TRAVEL_IN
*"     REFERENCE(IS_TRAVELX) TYPE  /DMO/IF_FLIGHT_LEGACY09=>TS_TRAVEL_INX
*"     REFERENCE(IT_BOOKING) TYPE  /DMO/IF_FLIGHT_LEGACY09=>TT_BOOKING_IN
*"       OPTIONAL
*"     REFERENCE(IT_BOOKINGX) TYPE
*"        /DMO/IF_FLIGHT_LEGACY09=>TT_BOOKING_INX OPTIONAL
*"     REFERENCE(IT_BOOKING_SUPPLEMENT) TYPE
*"        /DMO/IF_FLIGHT_LEGACY09=>TT_BOOKING_SUPPLEMENT_IN OPTIONAL
*"     REFERENCE(IT_BOOKING_SUPPLEMENTX) TYPE
*"        /DMO/IF_FLIGHT_LEGACY09=>TT_BOOKING_SUPPLEMENT_INX OPTIONAL
*"  EXPORTING
...
*"----------------------------------------------------------------------
  ...
  /dmo/cl_flight_legacy09=>get_instance( )->update_travel( EXPORTING is_travel              = is_travel
